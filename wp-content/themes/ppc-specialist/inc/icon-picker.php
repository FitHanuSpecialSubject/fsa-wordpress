...
class PPC_Specialist_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'ppc-specialist' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $ppc_specialist_font_awesome_icon_array = ppc_specialist_font_awesome_icon_array();
                    foreach ($ppc_specialist_font_awesome_icon_array as $ppc_specialist_font_awesome_icon) {
                            $icon_class = $this->value() == $ppc_specialist_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($ppc_specialist_font_awesome_icon).'"></i>
                            <span class="ppc-specialist-social-class">'.esc_attr($ppc_specialist_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function ppc_specialist_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'ppc-specialist-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'ppc_specialist_customizer_script' );

if(!function_exists('ppc_specialist_font_awesome_icon_array')){
    function ppc_specialist_font_awesome_icon_array(){
