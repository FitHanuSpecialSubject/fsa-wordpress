 ...
 * Control - Switch.
 *
 * @package PPC Specialist Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class PPC_Specialist_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'ppc-specialist-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'ppc-specialist-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
