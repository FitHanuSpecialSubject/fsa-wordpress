...
$zon_display_page_single_featured_image = $zon_settings['zon_display_page_single_featured_image']; ?>
<div class="wrap">
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			<?php global $zon_settings;
			while( have_posts() ) {
				the_post(); ?>
				<article id="post-<?php the_ID(); ?>" <?php post_class();?>>
					...
					<header class="entry-header">
						<?php if($zon_entry_meta_single!='hide'){ ?>
				...
				if ( is_singular( 'attachment' ) ) {
					...
					the_post_navigation( array(
								'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'zon' ),
							) );
				} elseif ( is_singular( 'post' ) ) {
				the_post_navigation( array(
						'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'zon' ) . '</span> ' .
							'<span class="screen-reader-text">' . __( 'Next post:', 'zon' ) . '</span> ' .
							'<span class="post-title">%title</span>',
						'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'zon' ) . '</span> ' .
							'<span class="screen-reader-text">' . __( 'Previous post:', 'zon' ) . '</span> ' .
							'<span class="post-title">%title</span>',
					) );
				}
			} ?>
