...
/**
 * Title: Hidden Single
 * Slug: carpenter-master/hidden-single
 * Inserter: no
 */
?>
...
<section class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--52);padding-bottom:var(--wp--preset--spacing--52)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|16"}},"layout":{"type":"constrained"}} -->
  <div class="wp-block-group"><!-- wp:post-terms {"term":"category","textAlign":"center","className":"is-style-default","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary"} /-->
    ...
    <div class="wp-block-group"><!-- wp:post-date {"isLink":true} /-->
      ...
      <p class="has-secondary-800-color has-text-color has-link-color has-18-font-size"><?php esc_html_e('·', 'carpenter-master'); ?></p>
      <!-- /wp:paragraph -->
      ...
      <div class="wp-block-group"><!-- wp:paragraph {"className":"is-style-text-aware-1","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary-800"}}}},"textColor":"secondary-800","fontSize":"minute"} -->
        <p class="is-style-text-aware-1 has-secondary-800-color has-text-color has-link-color has-minute-font-size"><?php esc_html_e('by', 'carpenter-master'); ?></p>
        <!-- /wp:paragraph -->
  ...
  <!-- wp:post-featured-image {"aspectRatio":"3/2","className":"is-style-image-comic is-style-default","style":{"border":{"radius":"12px"}}} /-->
  ...
  <div class="wp-block-comments"><!-- wp:heading -->
    <h2 class="wp-block-heading"><?php esc_html_e('Comments', 'carpenter-master'); ?></h2>
    <!-- /wp:heading -->
